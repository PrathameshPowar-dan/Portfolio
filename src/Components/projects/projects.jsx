            ...
            <div className='hero w-[99%] m-auto mt-11 rounded-2xl bg-black/35 p-6' id="projects" >
                ...
                <section className='w-full flex flex-col flex-wrap md:flex-row rounded-2xl'>
                    <div className="project flex flex-col justify-center items-center gap-2 w-11/12 m-auto mt-2 md:w-[30%] bg-[#1e1e1e]  border border-gray-700 pt-3 pb-3 mb-3  rounded-2xl" data-aos="zoom-in-up"
                        ...
                        <p className='text-amber-400 text-base md:text-2xl font-extrabold font-stretch-125%'>GenGenie</p>
                        <p className='text-gray-200 text-xs w-4/5 md:text-sm text-center'>Saas Dress tryon built using Next.js</p>
                        <div className="project-buttons flex justify-center gap-5">
                            <button ><a className='font-sm text-blue-400 flex justify-center items-center gap-0.5' href="https://gen-g-frontend.vercel.app/" target="_blank">Preview <VscOpenPreview /></a></button>
                            <button ><a className='font-sm text-blue-400 flex justify-center items-center gap-0.5' href="https://github.com/PrathameshPowar-dan/GenG-Backend" target="_blank">Code <FaGithub /></a></button>
                        </div>
                    </div>
                    <div className="project flex flex-col justify-center items-center gap-2 w-11/12 m-auto mt-2 md:w-[30%] bg-[#1e1e1e]  border border-gray-700 pt-3 pb-3 mb-3  rounded-2xl" data-aos="zoom-in-up"
                        data-aos-delay="200"
                    ...
                    <div className="project flex flex-col justify-center items-center gap-2 w-11/12 m-auto mt-2 md:w-[30%] bg-[#1e1e1e]  border border-gray-700 pt-3 pb-3 mb-3  rounded-2xl" data-aos="zoom-in-up"
                        ...
                        <div className="project-buttons flex justify-center gap-5">
                            <button ><a className='font-sm text-blue-400 flex justify-center items-center gap-0.5' href="https://dans-den.onrender.com/" target="_blank">Preview <VscOpenPreview /></a></button>
                            <button ><a className='font-sm text-blue-400 flex justify-center items-center gap-0.5' href="https://github.com/PrathameshPowar-dan/Food-Delivery" target="_blank">Code <FaGithub /></a></button>
                        </div>
                    </div>
                    <div className="project flex flex-col justify-center items-center gap-2 w-11/12 m-auto mt-2 md:w-[30%] bg-[#1e1e1e]  border border-gray-700 pt-3 pb-3 mb-3  rounded-2xl" data-aos="zoom-in-up"
                        data-aos-delay="200"
                    ...
                    <div className="banner w-full overflow-hidden md:mt-6 mt-0" data-aos="zoom-in-up"
                        ...
                        >
                            <div className="slide min-w-full h-56 md:h-72 flex justify-center items-center">
                                <img src="/GenGenie.webp" alt="Todo List" loading="lazy" className="h-full object-contain rounded-2xl" />
                            </div>
                            <div className="slide min-w-full h-56 md:h-72 flex justify-center items-center">
                                <img src="/ReCodeDitorWeb.webp" alt="Todo List" loading="lazy" className="h-full object-contain rounded-2xl" />
                            </div>
                            <div className="slide min-w-full h-56 md:h-72 flex justify-center items-center">
                                <img src="/DansFood.webp" alt="Todo List" loading="lazy" className="h-full object-contain rounded-2xl" />
                            </div>
                            <div className="slide min-w-full h-56 md:h-72 flex justify-center items-center">
